...
HD_PWD='C:/ECE/ECE3300L/MP3_Player/MP3_Player.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SongPlayer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SongPlayer.tcl -notrace
